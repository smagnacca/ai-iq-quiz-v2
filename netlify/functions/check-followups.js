...
<div style="max-width:600px;margin:0 auto;background:#FFFFFF">
  ...
  <div style="padding:32px 24px">
    ...
    <div style="background:#006644;border-radius:12px;padding:24px;text-align:center;margin-bottom:20px">
      ...
      <a href="${checkoutUrl}" style="display:inline-block;background:#EEAF00;color:#1B4332;font-weight:bold;font-size:15px;padding:14px 36px;border-radius:8px;text-decoration:none;border:2px solid #C9A84C;font-family:Arial,sans-serif">Get My Full Report — $4.99 →</a>
    </div>
